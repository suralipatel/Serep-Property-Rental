    ...
    return(
      ...
      {redirectVar}
        <Navbar style = {{backgroundColor: "transparent", background: "transparent", borderColor: "transparent"}}>
          <Navbar.Header>
            <Navbar.Brand>
              <a href="/" title = "SEREP" className = "logo"><img className="logo-img" alt="Homeaway White Logo" src={require('./LOGO2.png')} /></a>
            </Navbar.Brand>
          </Navbar.Header>
          <div>
            {/* <img alt="US Flag" src={require('./flag.png')}/> */}
            <button className="btn" style = {{fontColor : "#ffffff", backgroundColor:"transparent", background:"transparent", borderColor:"transparent"}} type="button">Trip Boards</button>
                  ...
                  <div className="row">
                    <div className="col-md-4 col-md-offset-3">
                      <div className="form-group">
                      	<input type="text" style ={{height: "45px", fontFamily: "Lato,Roboto,Arial,Helvetica Neue,Helvetica,sans-serif"}} className="form-control" name="search" id="search" placeholder="Where do you want to go?" onChange = {this.searchLocationChangeHandler}/>
                        <span className="glyphicon glyphicon-search form-control-feedback"></span>
                      </div>
                    </div>
                  <div className="col-md-offset-3">
                    <input style ={{width: "130px", height: "45px"}} onChange = {this.fromDateChangeHandler} type="date" name="fromdate"/>  
                  </div>
                  <div className="col-md-offset-3" style = {{marginLeft: "13px"}}>
                    <input style ={{width: "130px", height: "45px"}} onChange = {this.toDateChangeHandler} type="date" name="todate"/>  
                  </div>
                  <div className="col-md-offset-3" style = {{marginLeft: "13px"}}>
                    <div className="form-group">
                      <input type="number" min = "1" style ={{height: "45px", fontFamily: "Lato,Roboto,Arial,Helvetica Neue,Helvetica,sans-serif"}} className="form-control" placeholder="No of guests?" onChange = {this.guestsChangeHandler}/>
                      <span className="glyphicon glyphicon-search form-control-feedback"></span>
                    </div>
                  </div>
                  <div className="col-md-offset-3" style = {{marginLeft: "13px"}}>
                    <div className="form-group">
                      ...
                      <button className="btn btn-primary" onClick = {this.searchProperty} style = {{ height: "45px", borderColor: "#ffffff", backgroundColor:"#0067db", width: "120px", borderRadius: 25}} data-effect="ripple" type="button" tabIndex="5" data-loading-animation="true">
                        Search
                      </button>
                      </a>
                    </div>
